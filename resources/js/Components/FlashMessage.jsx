    ...
    <AnimatePresence>
      {isVisible && message && (
        <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 50 }} transition={{ duration: 0.3 }} className="fixed bottom-8 transform left-0 right-0 max-w-[700px] mx-auto z-50" >
          <div  className={`px-6 py-3 rounded-lg flex items-center shadow-lg border ${ type === "error" ? "bg-red-100 text-red-700 border-red-200" : "bg-green-100 text-green-800 border-green-300" }`}  role="alert" >
